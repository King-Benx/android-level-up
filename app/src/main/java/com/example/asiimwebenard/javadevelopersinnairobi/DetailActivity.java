...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String username = intent.getStringExtra(GithubUserAdapter.USERNAME).toString();
        textView.setText(username);
        repoView.setText(""+intent.getIntExtra(GithubUserAdapter.REPO_NUMBER,0));

        final String githubUrl = intent.getStringExtra(GithubUserAdapter.GITHUB_LINK).toString();
